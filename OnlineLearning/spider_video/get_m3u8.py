...
import re
import os
# https://vip2.slbfsl.com/20230512/A5uE1QAy/2000kb/hls/max.m3u8
url_prifix = 'https://cdn.aqd-tv.com/video/3e0633ea/playlist/3e0633ea'
url = 'https://cdn.aqd-tv.com/video/3e0633ea/playlist/3e0633ea.m3u8'
...
response = requests.get('https://cdn.aqd-tv.com/video/3e0633ea/playlist/3e0633ea.m3u8', headers=headers)
...
for i in ts:
    ...
    print(i, u)
    s = '%03d' %int(i)
    with open('./ts2/'+ s +'.ts', mode='wb') as file:
        file.write(r)
