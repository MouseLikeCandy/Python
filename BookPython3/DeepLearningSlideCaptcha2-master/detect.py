...
if __name__ == "__main__":
    ...
    parser.add_argument("--image_folder", type=str, default="data/captcha/test", help="path to dataset")
    ...
    output_folder = join(dirname(opt.image_folder), 'result').replace('/', '\\')
    print(output_folder)
    ...
    for batch_i, (img_paths, input_imgs) in enumerate(dataloader):
        img_paths_l = list(img_paths)
        img_paths_l[0] = (img_paths_l[0]).replace('\\', '/')
        img_paths = tuple(img_paths_l)
        # Configure input
